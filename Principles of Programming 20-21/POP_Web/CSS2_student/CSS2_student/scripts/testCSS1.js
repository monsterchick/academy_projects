...
QUnit.test("Element with ID of cssID has the correct styles", function(assert){
    ...
    if(window.getComputedStyle(elID, null).getPropertyValue("border-top-width")=="3px"){
...
QUnit.test("Class  cssArea1Class1 has the correct styles", function(assert){
    ...
    assert.strictEqual(testResult, true, "Class  p.cssArea1Class2 has the correct text alignment (" + classCenterred + ")");
})
...
QUnit.test("Table styles have been set correctly", function(assert){
    ...
    if(navigator.userAgent.indexOf("Chrome") > -1){
        //console.log("Chrome");
        if(window.getComputedStyle(elTable, null).getPropertyValue("width")=="699px"){
            //console.log("table width true");
            tblWidth = true;
        }
    } else {
        //console.log("Not Chrome");
        if(window.getComputedStyle(elTable, null).getPropertyValue("width")=="700px"){
            //console.log("table width true");
            tblWidth = true;
        }
    }
    */
    ...
    if((window.getComputedStyle(elTable, null).getPropertyValue("width")=="699px")||window.getComputedStyle(elTable, null).getPropertyValue("width")=="700px"){
        //console.log("table width true");
        tblWidth = true;
    }
...
QUnit.test("Table data cells have been set correctly", function(assert){
    ...
    //fudge due to bug in OSX 10.14 Firefox when getting border widths with JS - 1px set reads as 0.5px. 
    //This happens on my MBPro 13inch bit mot on my 15inch MBPro (which has OSX 10.15 installed)
    //if(navigator.userAgent.indexOf("Chrome") > -1){
        //console.log("Chrome");
        //console.log("Border Width = " + window.getComputedStyle(elTable, null).getPropertyValue("border-left-width"));
        if((window.getComputedStyle(elTable, null).getPropertyValue("border-top-width")=="1px")||(window.getComputedStyle(elTable, null).getPropertyValue("border-top-width")=="0.5px")){
            //console.log("td border width true");
            tdBorderWidth = true;
        }
   // } else {
        //console.log("Not Chrome");
        //if(window.getComputedStyle(elTable, null).getPropertyValue("border-top-width")=="0.5px"){
            //console.log("td border width true");
           // tdBorderWidth = true;
       // }
    //}
